...
class _CheckOutState extends State<CheckOut> {
  // to show data of a employee for Check Out

  List<Leaves> checkOutData = [
    Leaves(
        name: 'Hendry Adams',
        role: 'Accountant',
        time: '00:41:52',
  ...
  // to show images of a employee for Check Out
